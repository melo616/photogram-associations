...
class User < ApplicationRecord
  ...
  has_many(:sent_follow_requests, :class_name => "FollowRequest", :foreign_key => 
  "sender_id")
...
;
  ...
  # has_many(:followers, -> { where status: "accepted"}, :through = "accepted_received_follow_requests", :source => "user", :foreign_key => "sender")

  # has_many(:leaders, -> { where status: "accepted" } :through = "accepted_sent_follow_requests", :source => "user", :foreign_key => "recipient")
